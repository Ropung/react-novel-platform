    ...
    <main>
      ...
      <body className="w-[90vw] h-[70vh] bg-white border border-gray-300 shadow-md px-4 pt-4 overflow-hidden">
        ...
        <section className="w-full h-full overflow-y-scroll p-4 flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2">
            ...
            <li className="">
              ...
              <p>
                ...
                맞춤서비스 제공, 본인인증, 연령인증, 요금결제·정산을 목적으로
                개인정보를 처리합니다.
              </p>
            </li>
            <li className="">
          ...
          <p className="font-bold py-4 w-full">
            제2조(개인정보의 처리 및 보유 기간)
          </p>
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>
                ①(주)더드림메이커스은(는) 법령에 따른 개인정보 보유·이용기간
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>{`① < (주)더드림메이커스 >은(는) 다음의 개인정보 항목을 처리하고 있습니다.`}</p>
              <p>{` 1.<홈페이지 회원가입 및 관리>`}</p>
              <p>
                {`필수항목 : 이메일, 휴대전화번호, 자택주소, 자택전화번호, 비밀번호 질문과 답, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 회사전화번호, 직책, 부서, 회사명, 직업, 기념일, 결혼여부, 취미, 신체정보, 학력, 종교, 신용카드정보, 은행계좌정보, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록, 법정대리인 이름, 법정대리인 자택 전화번호, 법정대리인 자택 주소, 법정대리인 휴대전화번호`}
              </p>
              <p>선택항목 :</p>
            </li>
          </ul>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>{`① <개인정보처리자명>은(는) 만 14세 미만 아동에 대해 개인정보를 수집할 때 법정대리인의 동의를 얻어 해당 서비스 수행에 필요한 최소한의 개인정보를 수집합니다.`}</p>
              <p>{`• 필수항목 : 법정 대리인의 성명, 관계, 연락처`}</p>
              <p>
                {`② 또한, <개인정보처리자명>의 <처리목적> 관련 홍보를 위해 아동의 개인정보를 수집할 경우에는 법정대리인으로부터 별도의 동의를 얻습니다.`}
              </p>
              <p>{`③ <개인정보처리자명>은(는) 만 1 4세 미만 아동의 개인정보를 수집할 때에는 아동에게 법정대리인의 성명, 연락처와 같이 최소한의 정보를 요구할 수 있으며, 다음 중 하나의 방법으로 적법한 법정대리인이 동의하였는지를 확인합니다.`}</p>
              <p>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>{`① < (주)더드림메이커스 >은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.`}</p>
              <p>{`② < (주)더드림메이커스 >은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.`}</p>
              <p>{`1. < >`}</p>
              <p>제공받는 자의 개인정보 이용목적 :홈페이지 회원가입 및 관리</p>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>{`① <개인정보처리자명>은(는) 회사 서비스 제공을 위한 데이터 저장 및 서비스 운영 등 업무를 국외 법인인 Amazon Web Service Inc에 아래와 같이 위탁하고 있습니다.`}</p>
              <p>{`1. 수탁업체: Amazon Web Service Inc`}</p>
              <p>{`2. 수탁업체의 위치: ○국가 ○시 ○구 ○동 건물명(국가, 도시 등 구체적 주소 작성)`}</p>
              <p>
                3. 위탁 일시 및 방법: 서비스 제공 과정 중 정보통신망을 통해
                수시로 이전
              </p>
              <p>4. 정보관리책임자의 연락처 : 전자우편 주소, 전화번호</p>
              <p>
                5. 위탁하는 개인정보 항목 : 서비스 이용 중 수집되는 개인정보 및
                로그 정보
              </p>
              <p>
                6. 위탁 업무 내용 : 회사 서비스 제공을 위한 데이터 저장 및
                서비스 운영 등
              </p>
              <p>
                7. 개인정보의 보유 및 이용기간 :이용자의 서비스 가입기간 동안
                보유
              </p>
            </li>
          </ul>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>{`① < (주)더드림메이커스 > 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.`}</p>
              ...
              <p>1. 파기절차</p>
              <p>
                {` < (주)더드림메이커스 > 은(는) 파기 사유가 발생한 개인정보를 선정하고, < (주)더드림메이커스 > 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.`}
              </p>
              <p>2. 파기 방법</p>
              <p>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>{`① <개인정보처리자명>은(는) 1년간 서비스를 이용하지 않은 이용자는 휴면계정으로 전환하고, 개인정보를 별도로 분리하여 보관합니다. 분리 보관된 개인정보는 1년간 보관 후 지체없이 파기합니다.`}</p>
              <p>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>
                {` ① 정보주체는 (주)더드림메이커스에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.`}
              </p>
              <p>
                {`② 제1항에 따른 권리 행사는(주)더드림메이커스에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 (주)더드림메이커스은(는) 이에 대해 지체 없이 조치하겠습니다.`}
              </p>
              <p>
              ...
              <p>
                ⑥ (주)더드림메이커스은(는) 정보주체 권리에 따른 열람의 요구,
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p className="font-bold py-4 w-full">
                {` < (주)더드림메이커스 >은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.`}
              </p>
              <p>1. 정기적인 자체 감사 실시</p>
              <p>
              ...
              <p>
                {`<(주)더드림메이커스>('싸요싸')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.`}
              </p>
          ...
          <p className="font-bold py-4 w-full">
            제11조(개인정보를 자동으로 수집하는 장치의 설치·운영 및 그 거부에
            관한 사항)
          </p>
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>
                ① (주)더드림메이커스 은(는) 이용자에게 개별적인 맞춤서비스를
              ...
              <p>
                x 다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이
                발생할 수 있습니다.
              </p>
            </li>
          </ul>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              ...
              <div>
                <p className="font-bold"> 수집하는 행태정보의 항목</p>
                <p className="font-bold">행태정보 수집 방법</p>
                <p className="font-bold">행태정보 수집 목적</p>
                <p className="font-bold">보유·이용기간 및 이후 정보처리 방법</p>
              </div>
              <p>{`<온라인 맞춤형 광고 등을 위해 제3자(온라인 광고사업자 등)가 이용자의 행태정보를 수집·처리할수 있도록 허용한 경우>`}</p>
              <p>
              ...
              <p>
                ...
                변경은 웹사이트 자동로그인 등 일부 서비스의 이용에 영향을 미칠
                수 있습니다.
              </p>
              ...
              <p>부서명 : 개인정보담당부서</p>
              <p>담당자 : 박석우</p>
              <p>연락처 : 010-7222-9995, thedreamakers@dpayshop.co.kr</p>
            </li>
          </ul>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p>
                {`< (주)더드림메이커스 > 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.`}
              </p>
              <p>
                {`이에 따라 < (주)더드림메이커스 > 가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은 사항을 고려하였습니다.`}
              </p>
              <p>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p className="font-bold  w-full">{`< (주)더드림메이커스 > 은(는) 다음과 같은 목적으로 가명정보를 처리하고 있습니다.`}</p>
              <p className="font-bold w-full">▶ 가명정보의 처리 목적</p>
              <p className="font-bold w-full">
                - 개인정보는 개인에 관한 정보들이 모두 포함되어 있어 처리
                활용하는 과정에서 개인의 사생활 침해 등 다양한 문제가 발생할 수
                있으므로, 개인정보를 안전하게 활용하기 위해서는 특정 개인에 대한
                정보가 노출되지 않도록 기술적 안전조치(가명처리) 수행
              </p>
              <p className="font-bold w-full">▶ 가명정보의 처리 및 보유기간</p>
              <p className="font-bold w-full">
                - 회원탈퇴시 까지 반영구적으로 보유.
              </p>
              <p className="font-bold w-full">
              ...
              <p className="text-gray-400">
                6. 조약, 그 밖의 국제협정의 이행을 위하여 외국정부 또는
              ...
              <p className="font-bold">▶ 가명처리하는 개인정보의 항목</p>
              <p className="font-bold">- 회원 성명 ,휴대폰번호,주소,나이 </p>
            </li>
          </ul>
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p className="font-bold w-full">
                ① (주)더드림메이커스 은(는) 개인정보 처리에 관한 업무를 총괄해서
                책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제
                등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
              </p>
              <p className="font-bold w-full">▶ 개인정보 보호책임자</p>
              <p className="font-bold w-full">성명 :이길범</p>
              <p className="font-bold w-full">직책 :관리자</p>
              <p className="font-bold w-full">직급 :대표</p>
              <p className="font-bold w-full">
                연락처 :01082380110, thedreamakers@naver.com,
              </p>
              <p className="font-bold w-full">
                ※ 개인정보 보호 담당부서로 연결됩니다.
              </p>
              <p className="font-bold w-full">▶ 개인정보 보호 담당부서</p>
              <p className="font-bold w-full">부서명 :개인정보담당부서</p>
              <p className="font-bold w-full">담당자 :박석우</p>
              <p className="font-bold w-full">
                연락처 :01072229995, thedreamakers@naver.com,
              </p>
              <p className="font-bold w-full">
                ② 정보주체께서는 (주)더드림메이커스 의 서비스(또는 사업)을
                이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
                피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
                문의하실 수 있습니다. (주)더드림메이커스 은(는) 정보주체의
                문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
              </p>
            </li>
          </ul>
          <p className="font-bold py-4 w-full">제16조(국내대리인의 지정)</p>
          <ul className="flex flex-col gap-2">
            <li className="">
              <p className="font-bold w-full">{`정보주체는 ｢개인정보 보호법｣ 제39조의11에 따라 지정된 < (주)더드림메이커스 >의 국내대리인에게 개인정보 관련 고충처리 등의 업무를 위하여 연락을 취할 수 있습니다. < (주)더드림메이커스 >은(는) 정보주체의 개인정보 관련 고충처리 등 개인정보 보호책임자의 업무 등을 신속하게 처리할 수 있도록 노력하겠습니다.`}</p>
              <p className="font-bold w-full">
                {" "}
                {`▶ < (주)더드림메이커스 > 은(는) ｢개인정보 보호법｣ 제39조의11에 따라 국내대리인을 지정하였습니다.`}
              </p>
              <p className="font-bold w-full">
                - 국내대리인의 성명 : (주)더드림메이커스 이길범
              </p>
              <p className="font-bold w-full">
                - 국내대리인의 주소 : 광주광역시 동구 충장로5가 58-3
              </p>
              <p className="font-bold w-full">
                - 국내대리인의 전화번호 : 010-8238-0110
              </p>
              <p className="font-bold w-full">
                - 국내대리인의 전자우편 주소 : thedreamakers@naver.com
              </p>
            </li>
          </ul>
          <p className="font-bold py-4 w-full">
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              ...
              <p className="font-bold w-full">{`< (주)더드림메이커스 >은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.`}</p>
              <p className="font-bold w-full">
                ▶ 개인정보 열람청구 접수·처리 부서
              </p>
              <p className="font-bold w-full">부서명 :개인정보담당부서</p>
              <p className="font-bold w-full">담당자 :이길범</p>
              <p className="font-bold w-full">연락처 : 010-8238-0110</p>
              <p className="font-bold w-full"></p>
            </li>
          </ul>
          <p className="font-bold py-4 w-full">
          ...
          <ul className="flex flex-col gap-2">
            <li className="">
              <p className="font-bold w-full">
                ① 이 개인정보처리방침은 2022년 8월 15부터 적용됩니다.
              </p>
              <p className="font-bold w-full">
