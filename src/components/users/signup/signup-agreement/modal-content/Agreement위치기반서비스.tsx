const Agreement위치기반서비스 = () => {
  return (
    <main>
      {/* 기본약관  */}
      <body className="w-[90vw] h-[80vh] bg-white border border-gray-300 shadow-md px-4 pb-20 pt-4">
        <header className="flex justify-between items-center l px-2 border-b pb-4">
          <h1 className="text-4xl">위치기반</h1>
        </header>
        <section className="w-full h-full overflow-y-scroll p-4 flex flex-col gap-4">
          <p>제 1 조 (목적)</p>
          <p>
            이 약관은 제공하는 위치기반서비스와 관련하여 회사와
          ...
          <p>제 3 조 (서비스 내용 및 요금)</p>
          <p>
            ①회사는 위치정보사업자로부터 위치정보를 전달받아 아래와 같은
            위치기반서비스를 제공합니다.
          </p>
          <p>
            1.GeoTagging 서비스: 게시물 또는 이용자가 저장하는 콘텐츠에 포함된
          ...
          <p>
            2.위치정보를 활용한 검색결과 및 콘텐츠 제공 : 정보 검색을 요청하거나
            개인위치정보주체 또는 이동성 있는 기기의 위치정보를 제공 시 본
            위치정보를 이용한 검색결과, 주변결과(맛집, 주변업체, 교통수단 등),
            번역결과를 제시합니다.
          </p>
          <p>
            3.이용자 위치를 활용한 광고정보 제공: 검색결과 또는 기타 서비스 이용
            과정에서 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여
            광고소재를 제시합니다.
          </p>
          <p>
            4.이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는
            기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도
            등을 차단합니다.
          </p>
          <p>
            5.길 안내 등 생활편의 서비스 제공: 교통정보와 길 안내 등 최적의
            경로를 지도로 제공하며, 주변 시설물 찾기, 뉴스/날씨 등 생활정보,
            긴급구조 서비스, 주소 자동 입력 등 다양한 운전 및 생활 편의 서비스를
            제공합니다.
          </p>
          <p>②제1항 위치기반서비스의 이용요금은 무료입니다.</p>
          <p>제 4 조 (개인위치정보주체의 권리)</p>
          <p>
          ...
          <p>
            ④개인위치정보주체는 회사에 대하여 아래 자료의 열람 또는 고지를
          ...
          <p>제 6 조 (위치정보 이용ㆍ제공사실 확인자료 보유근거 및 보유기간)</p>
          <p>
          ...
          <p>제 8 조 (개인위치정보 제3자 제공 시 즉시 통보)</p>
          <p>
          ...
          <p>제 9 조 (8세 이하의 아동 등의 보호의무자의 권리)</p>
          <p>
          ...
          <p>제 10 조 (개인위치정보의 보유목적 및 이용기간)</p>
          <p>
            ①회사는 위치기반서비스를 제공하기 위해 필요한 최소한의 기간 동안
            개인위치정보를 보유 및 이용합니다.
          </p>
          <p>
            ②회사는 대부분의 위치기반서비스에서 개인위치정보를 일회성 또는
            임시로 이용 후 지체없이 파기합니다. 단, ‘GeoTagging’ 서비스와 같이
            이용자가 게시물, 콘텐츠와 함께 개인위치정보를 네이버 서비스에 게시
            또는 보관하는 경우, 해당 게시물, 콘텐츠의 보관기간 동안
            개인위치정보가 함께 보관됩니다.
          </p>
          <p>제 11 조 (손해배상)</p>
          <p>
            ...
            과실이 없음을 입증하지 아니하면 책임을 면할 수 없습니다. 제 12 조
            (분쟁의 조정)
          </p>
          <p>
          ...
          <p>제 13 조 (사업자 정보 및 위치정보 관리책임자)</p>
          <p>
            ①회사의 상호, 주소 및 연락처는 다음과 같습니다. 상호: 네이버주식회사
          ...
          <p>위치정보 관리책임자 : 이진규 CPO / DPO</p>
          <p>(개인정보 보호책임자 겸직) 메일 : 문의하기</p>
        </section>
      </body>
    </main>
  );
...
export default Agreement위치기반서비스;
