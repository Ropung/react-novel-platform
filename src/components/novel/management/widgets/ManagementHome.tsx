...
import { ManagementStepName } from "../ManagementPage";

export interface ManagementWorkHomeProp {
  setStepName: React.Dispatch<React.SetStateAction<ManagementStepName>>;
}

const ManagementHome: FunctionComponent<ManagementWorkHomeProp> = (props) => {
  const { setStepName } = props;
  const { MANAGE_HOME, MANAGEMENTLIST: MANAGEMENT, MANAGE_ADD } = Path;
